...
<header class="global-header">
  <div class="header-inner desktop-bar">
    ...
    <a class="header-rfq" href="<?php echo esc_url(tio2_field('header.nav.7.href')); ?>"><?php echo esc_html(tio2_field('header.nav.7.label')); ?></a>
  </div>
  <div class="header-inner mobile-bar">
    <a class="logo" href="/" aria-label="TiO2 Malaysia home"><?php tio2_logo('header'); ?></a>
    <a class="mobile-rfq" href="<?php echo esc_url(tio2_field('header.nav.7.href')); ?>" aria-label="<?php echo esc_attr(tio2_field('header.nav.7.label')); ?>">RFQ</a>
